...
public interface MPUSBApi extends Library {
	 ...
	 * @return
	 */
	int MPUSBGetDeviceCount(String pVID_PID);
	 ...
	 *         ======================================================
	 */
	Pointer MPUSBOpen(int instance, // Input
	 ...
	 * @return
	 */
	int MPUSBRead(Pointer handle, // Input
	 ...
	 * @return
	 */
	int MPUSBWrite(Pointer handle, // Input
			Pointer pData, // Input
			int dwLen, // Input
	 ...
	 * @return
	 */
	int MPUSBReadInt(Pointer handle, // Input
			Pointer pData, // Output
			int dwLen, // Input
			IntByReference pLength, // Output 
			int dwMilliseconds); // Input
	 ...
	 * @return
	 */
	boolean MPUSBClose (Pointer handle);
	 ...
	 * @return
	 */
	int MPUSBGetDeviceDescriptor(Pointer handle, // Input
	 ...
	 * @return
	 */
	int MPUSBGetConfigurationDescriptor(Pointer handle, // Input
			byte bIndex, // Input
			Pointer pDevDsc, // Output
			int dwLen, // Input
			IntByReference pLength); // Output
	 ...
	 * @return
	 */
	int MPUSBGetStringDescriptor(Pointer handle, // Input
			byte bIndex, // Input
			short wLangId, // Input
			Pointer pDevDsc, // Output
			int dwLen, // Input
	 ...
	 * @return
	 */
	int MPUSBSetConfiguration(Pointer handle, // Input
